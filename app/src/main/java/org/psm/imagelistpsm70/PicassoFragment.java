...
public class PicassoFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View v = inflater.inflate(R.layout.fragment_picasso, container, false);

        mRecyclerView = (RecyclerView)v.findViewById(R.id.picassoRecycleView);
    ...
    private void parseJsonFromGson(String json){
        ...
        TMDbRecycleAdapter mAdapter = new TMDbRecycleAdapter(getActivity(), imageUrlList);
